...
## Script
O script utilizado para compor a Análise Exploratória, Preparação e Treinamento dos dados do Projeto podem ser encontrados na pasta [Script](./Script). Esses scripts foram desenvolvidos em Python e utilizam bibliotecas como pandas, NumPy, Scikit-Learn e matplotlib.
